...
public class Item {
	...
	public static boolean playerLegs(int itemId) {
		String[] data = {
			...
			"platelegs", "robe", "plateskirt", "legs", 
			"shorts", "Skirt", "skirt", "cuisse", "Trousers", "Pantaloons", "Leggings",
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	private static String[] fullhat = {
		"med helm", "coif", "Dharok's helm" ,"Void melee helm", "Slayer helmet", "hood", "Initiate helm",
		...
		"Larupia hat", "mask", "Kyatt hat", "Bomber cap", "Dwarven helmet", "Visor",
	};
...
itemStackable[10832] = true;
itemStackable[7478] = true;
itemStackable[10833] = true;
itemStackable[10834] = true;
itemStackable[10835] = true;
itemStackable[361] = true;
