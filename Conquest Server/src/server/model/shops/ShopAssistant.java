	...
	**/
	...
	public void buyFromShopPrice(int removeId, int removeSlot){
		if (c.myShopId == 7390 && c.myShopClient != null && !c.myShopClient.playerName.equals(c.playerName)) {
			c.sendMessage(c.getItems().getItemName(removeId)+": currently costs " + c.myShopClient.playerShopP[removeSlot] + " Dragon Tokens.");
			return;
		}else if (c.myShopId == 7390 && c.myShopClient != null && c.myShopClient.playerName.equals(c.playerName)) {
			c.sendMessage(c.getItems().getItemName(removeId)+": currently costs " + c.playerShopP[removeSlot] + " Dragon Tokens.");
			return;
		}
		...
		String ShopAdd = "";
		if (c.myShopId == 18) {
			c.sendMessage(c.getItems().getItemName(removeId)+": currently costs " + getSpecialItemValue(removeId) + " EXLp.");
			return;
		}
		if (c.myShopId == 73) {
			c.sendMessage(c.getItems().getItemName(removeId)+": currently costs " + getSpecialItemValue(removeId) + " EXLp.");
		...
		if (c.myShopId == 10 || c.myShopId == 11 || c.myShopId == 12) {
			c.sendMessage(c.getItems().getItemName(removeId)+": currently costs " + getSpecialItemValue(removeId) + " God Points");
			return;
		}
		if (c.myShopId == 9) {
		...
		if (c.myShopId == 78) {
			c.sendMessage(c.getItems().getItemName(removeId)+": currently costs " + getSpecialItemValue(removeId) + " Dragon Tokens.");
			return;
		}
...
case 13879:
			...
			case 11706:
			return 100;
			case 1048:///Exilium Level Point Shop
			return 1550;
			case 1046:///Exilium Level Point Shop
			return 1550;
			case 1042:///Exilium Level Point Shop
			return 1550;
			case 1044:///Exilium Level Point Shop
			return 1550;
			case 1040:///Exilium Level Point Shop
			return 1550;
			case 1038:///Exilium Level Point Shop
			return 1550;
			case 11694:///Exilium Level Point Shop
			return 645;
			
			case 11724:///Exilium Level Point Shop
			return 725;
			case 11726:///Exilium Level Point Shop
			return 725;
			case 11728:///Exilium Level Point Shop
			return 655;
			case 19337:///Exilium Level Point Shop
			return 35;
			case 19339:///Exilium Level Point Shop
			return 35;
			case 19338:///Exilium Level Point Shop
			return 35;
			case 19336:///Exilium Level Point Shop
			return 35;
			
			case 19340:///Exilium Level Point Shop
			return 10;
			case 13006:///Exilium Level Point Shop
			return 4;
			case 13742:///Exilium Level Point Shop
			return 1000;
			case 13740:///Exilium Level Point Shop
			return 1000;
			case 13738:///Exilium Level Point Shop
			return 750;
			case 13744:///Exilium Level Point Shop
			return 750;

	case 1419: ///Exilium Donor Point Shop
	return 175;
	case 4083:
	return 225;
	case 19160:
	...
	return 525;
			...
			case 13858: ///Exilium Slayer Master
return 350;
case 13861: ///Exilium Slayer Master
return 350;
case 13864: ///Exilium Slayer Master
return 350;
case 13867: ///Exilium Slayer Master
return 350;
case 13870: ///Exilium Slayer Master
return 350;
case 13873: ///Exilium Slayer Master
return 350;
case 13876: ///Exilium Slayer Master
return 350;
case 13896: ///Exilium Slayer Master
return 350;
case 13884: ///Exilium Slayer Master
return 350;
case 13890: ///Exilium Slayer Master
return 350;
case 13902: ///Exilium Slayer Master
return 600;
case 13887: ///Exilium Slayer Master
return 350;
case 20051: ///Exilium Slayer Master
return 600;
case 19828: ///Exilium Slayer Master
return 900;
case 4212: ///Exilium Slayer Master
return 450;
case 19816: ///Exilium Slayer Master
return 900;
case 19817: ///Exilium Slayer Master
return 900;
case 19821: ///Exilium Slayer Master
return 900;
case 19822: ///Exilium Slayer Master
return 900;
case 10887: ///Exilium Slayer Master
return 600;
case 13893: ///Exilium Slayer Master
return 350;
case 13899: ///Exilium Slayer Master
return 600;
case 13905: ///Exilium Slayer Master
return 600;
case 6570: ///Exilium Slayer Master
return 35;
case 10548: ///Exilium Slayer Master
return 50;
case 20072: ///Exilium Slayer Master
return 35;
case 15018: ///Exilium Slayer Master
return 125;
case 15019: ///Exilium Slayer Master
return 125;
case 15020: ///Exilium Slayer Master
return 125;
case 15220: ///Exilium Slayer Master
return 125;
case 4151:
return 25;
...
public boolean addShopItem(int itemID, int amount) {
	...
	public boolean buyItem(int itemID, int fromSlot, int amount) {
		if(c.myShopId == 7390 && c.myShopClient != null && !c.myShopClient.properLogout && !c.playerName.equals(c.myShopClient.playerName)){
			...
			c.getItems().resetItems(3823);;
			c.sendMessage("You just bought "+bought+" "+c.getItems().getItemName(itemID)+" for "+ (bought*price) +"Dragon Tokens.");
			c.myShopClient.sendMessage(c.playerName+" has bought "+bought+" "+c.getItems().getItemName(itemID)+" from you!");
			c.myShopClient.sendMessage("You now have "+c.myShopClient.playerCollect+" Dragon Tokens to collect (::collect)");
			}
			return false;
...
if (amount > 1000) {
			...
			for (int i = amount; i > 0; i--) {
				...
				if(Slot4 == -1 && c.myShopId == 78) {
					c.sendMessage("You don't have enough Dragon Tokens.");
					break;
				}
                ...
                if(c.myShopId == 29 || c.myShopId == 30 || c.myShopId == 31) {
                	...
                	if (c.pkPoints >= TotPrice2) {
						...
						c.sendMessage("You don't have enough Exilium Points.");
						break;
					}
                }
...
if (c.myShopId == 10 || c.myShopId == 11 || c.myShopId == 12) {
				if (c.toTAL >= getSpecialItemValue(itemID)) {
					if (c.getItems().freeSlots() > 0){
						c.toTAL -= getSpecialItemValue(itemID);
						c.getItems().addItem(itemID,1);
						c.getItems().resetItems(3823);
					}
				} else {
					c.sendMessage("You do not have enough God Points to buy this item.");			
				}

			}
if (c.myShopId == 9) {
				if (c.SlayPts >= getSpecialItemValue(itemID)) {
					if (c.getItems().freeSlots() > 0){
						c.SlayPts -= getSpecialItemValue(itemID);
						c.getItems().addItem(itemID,1);
						c.getItems().resetItems(3823);
					}
				} else {
		...
		public int[] skillCapes = {9747,9753,9750,9768,9756,9759,9762,9801,9807,9783,9798,9804,9780,9795,9792,9774,9771,9777,9786,9810,9765,9948,9790,12524};
		...
		public void setupSkillCapes(int capes, int capes2) {
			synchronized(c) {
				...
				c.myShopId = 14;
				c.getPA().sendFrame248(3824, 3822);
				c.getPA().sendFrame126("Exilium SkillCape Shop", 3901);
