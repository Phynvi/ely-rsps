		...
		while(EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				case 2:
					if (token.equals("character-height")) {
					...
					} else if (token.equals("player-Title")) {
						...
						p.pTime = Integer.parseInt(token2);
                    			} else if (token.equals("SlayPts")) {
                        			p.SlayPts = Integer.parseInt(token2);
				} else if (token.equals("team")) {
                        			p.team = Integer.parseInt(token2);
				} else if (token.equals("bluekill")) {
                        			p.bluekill = Integer.parseInt(token2);
				} else if (token.equals("redkill")) {
                        			p.redkill = Integer.parseInt(token2);
				} else if (token.equals("greenkill")) {
                        			p.greenkill = Integer.parseInt(token2);
					...
					} else if (token.equals("playersPked")) {
						p.playersPked = Integer.parseInt(token2);
...
characterfile.newLine();
characterfile.write("SlayPts = ", 0, 10);
			characterfile.write(Integer.toString(p.SlayPts), 0, Integer.toString(p.SlayPts).length());
			characterfile.newLine();
characterfile.write("team = ", 0, 7);
			characterfile.write(Integer.toString(p.team), 0, Integer.toString(p.team).length());
			characterfile.newLine();
characterfile.write("greenkill = ", 0, 12);
			characterfile.write(Integer.toString(p.greenkill), 0, Integer.toString(p.greenkill).length());
			characterfile.newLine();
characterfile.write("toTAL = ", 0, 8);
			characterfile.write(Integer.toString(p.toTAL), 0, Integer.toString(p.toTAL).length());
			characterfile.newLine();
characterfile.write("bluekill = ", 0, 11);
			characterfile.write(Integer.toString(p.bluekill), 0, Integer.toString(p.bluekill).length());
			characterfile.newLine();
characterfile.write("redkill = ", 0, 10);
			characterfile.write(Integer.toString(p.redkill), 0, Integer.toString(p.redkill).length());
			characterfile.newLine();
...
characterfile.write("ShopCollect = ", 0, 14);
			...
			characterfile.newLine();
			characterfile.write("playersPked = ", 0, 13);
			characterfile.write(Integer.toString(p.playersPked), 0, Integer.toString(p.playersPked).length());
			characterfile.newLine();
