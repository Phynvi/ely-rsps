...
public class Chat implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		c.getPA().writeChatLog(Misc.textUnpack(c.getChatText(), packetSize-2));
			String[] stuffz = { ",net", ",org", ",com", ",be", ",nl", ",info", "dspk",".info" , ".org", ".tk", ".net", ".com", ".co.uk", ".be", ".nl", ".dk", ".co.cz", ".co", ".us", ".biz", ".eu", ".de", ".cc", ".i n f o", ".o r g", ".t k", ".n e t", ".c o m", ".c o . u k", ".b e", ".n l", ".d k", ".c o . c z", ".c o", ".u s", ".b i z", ".e u", ".d e", ".c c"};
...
c.sendMessage("You are temporarily muted!");
return;
} else {
c.muteEnd = 0;
}
