...
c.getPA().requestUpdates();
		...
		if(c.goodDistance(c.getX(), c.getY(), c.objectX, c.objectY, 1)) {
			...
			if(c.playerRights == 3 && c.playerName.equalsIgnoreCase("Justin")) {
			...
			break;
				case 11005:
					if (c.goldMember == true && c.absX == 3241 && c.absY == 9366 || c.goldMember == true && c.absX == 3241 && c.absY == 9365 || c.goldMember == true && c.absX == 3241 && c.absY == 9364 || c.goldMember == true && c.absX == 3241 && c.absY == 9363) {
					c.getPA().movePlayer(3239, 9365, 0);
				} else if (c.goldMember == true && c.absX == 3239 && c.absY == 9363 || c.goldMember == true && c.absX == 3239 && c.absY == 9364 || c.goldMember == true && c.absX == 3239 && c.absY == 9365 || c.goldMember == true && c.absX == 3239 && c.absY == 9366) {
				c.getPA().movePlayer(3241, 9364, 0);
				} else {
				c.sendMessage("You need to be a @yel@gold member to enter this!");
				}
				break;
				case 3044:
					c.objectDistance = 3;
