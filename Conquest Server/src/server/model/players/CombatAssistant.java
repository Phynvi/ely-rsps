...
public void npcMageDamage(int damage) {
	...
	*/
	...
	if (c.playerEquipment[c.playerWeapon] == 20051) {
		c.spellId = 51;
	}
	...
	if(c.playerEquipment[c.playerWeapon] == 15241 && 15243 != c.playerEquipment[c.playerArrows]){
		...
		if (Server.npcHandler.npcs[i].npcType == 912 && c.team == 1) {
		  c.sendMessage("These are members of your team! Do not kill them!");
                return;
		} else 
		if (Server.npcHandler.npcs[i].npcType == 913 && c.team == 2) {
		  c.sendMessage("These are members of your team! Do not kill them!");
                return;
	} else
if (Server.npcHandler.npcs[i].npcType == 914 && c.team == 3) {
		  c.sendMessage("These are members of your team! Do not kill them!");
                return;
}
