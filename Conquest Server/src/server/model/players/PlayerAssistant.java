...
c.Sara = 0;
c.Zammy = 0;
c.sendMessage("A magical force resets your kill count!");
}
}
...
int totalExp = (c.playerXP[0] + c.playerXP[1] + c.playerXP[2] + c.playerXP[3] + c.playerXP[4] + c.playerXP[5] + c.playerXP[6] + c.playerXP[7] + c.playerXP[8] + c.playerXP[9] + c.playerXP[10] + c.playerXP[11] + c.playerXP[12] + c.playerXP[13] + c.playerXP[14] + c.playerXP[15] + c.playerXP[16] + c.playerXP[17] + c.playerXP[18] + c.playerXP[19] + c.playerXP[20] + c.playerXP[21] + c.playerXP[22] + c.playerXP[23] + c.playerXP[24]);
...
return false;
	...
	public void resetZombies() {
		...
		c.zombiesToKill = -1;
		c.zombiesKilled = -1;
		c.getPA().movePlayer(2604, 9899, 0);
	}
	...
	public void enterZombies() {
		...
		c.zombiesToKill = -1;
		c.zombiesKilled = -1;
		Server.zombieCaves.spawnNextZombies(c);
	}
...
return;
		...
		if(c.duelStatus <= 4 && !c.getPA().inPitsWait()) { // if we are not in a duel we must be in wildy so remove items
			if (!c.inPits && !c.inFightCaves() && !c.inPcGame() && !c.inFunPk() && !c.inZombieCaves()) {
					c.getItems().resetKeepItems();
				if((c.playerRights == 2 && Config.ADMIN_DROP_ITEMS) || c.playerRights != 2 || !c.isInBoss()) {
...
int totalExp = (c.playerXP[0] + c.playerXP[1] + c.playerXP[2] + c.playerXP[3] + c.playerXP[4] + c.playerXP[5] + c.playerXP[6] + c.playerXP[7] + c.playerXP[8] + c.playerXP[9] + c.playerXP[10] + c.playerXP[11] + c.playerXP[12] + c.playerXP[13] + c.playerXP[14] + c.playerXP[15] + c.playerXP[16] + c.playerXP[17] + c.playerXP[18] + c.playerXP[19] + c.playerXP[20] + c.playerXP[21] + c.playerXP[22] + c.playerXP[23] + c.playerXP[24]);
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			...
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Attack!");
		}
		c.lvlPoints +=15;
			c.sendMessage("Congratulations you have reached level 99 in Attack!");
			c.sendMessage("For a bonus Conquest 317 has given you 15 Level Points! ENJOY!"); 
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Defence!");
		}
			c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j]; 
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Strength!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Constitution!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Ranged!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Prayer!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Magic!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Cooking!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Woodcutting!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Fletching!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Fishing!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Firemaking!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Crafting!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Smithing!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Mining!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Herblore!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Agility!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Thieving!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j]; 
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Slayer!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Farming!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			 all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Runecrafting!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;	
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Hunter!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Summoning!");
		}
		c.lvlPoints +=15;
	...
	c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Construction!");
		}
		c.lvlPoints +=15;
			c.sendMessage("Congratulations you have reached level 99 in Construction!");
			c.sendMessage("For a bonus Conquest 317 has given you 15 Level Points! ENJOY!");
...
c.lvlPoints +=1;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<col=13238272><shad=16711680>[Conquest 317] "+ Misc.optimizeText(c.playerName) +" has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Dungeoneering!");
		}
		c.lvlPoints +=15;
			c.sendMessage("Congratulations you have reached level 99 in Dungeoneering!");
			c.sendMessage("For a bonus Conquest 317 has given you 15 Level Points! ENJOY!");
		c.getItems().addItem(9790, 1);
		c.getItems().addItem(9791, 1);
		break;
...
public void refreshSkill(int i) {
    switch (i) {
		...
		sendFrame126("To go: "+ getXPForLevel(getLevelForXP(c.playerXP[0]) + 1) + "", 31112);
        break;
        ...
        case 22://summoning
        sendFrame126("" + c.playerLevel[22] + "", 31239);
        sendFrame126("" + getLevelForXP(c.playerXP[22]) + "", 31240);
        sendFrame126("Exp: " + c.playerXP[22] + "", 31238);
        break;
 
        case 23://construction
        sendFrame126("" + c.playerLevel[23] + "", 31149);
        sendFrame126("" + getLevelForXP(c.playerXP[23]) + "", 31150);
        sendFrame126("Exp: " + c.playerXP[23] + "", 31148);
        break;
...
objectToRemove2(2526, 4833);
objectToRemove2(2525, 4833);
objectToRemove2(2524, 4833);
objectToRemove2(2526, 4832);
objectToRemove2(2525, 4832);
objectToRemove2(2524, 4832);

objectToRemove(2515, 3856);
objectToRemove(2515, 3857);
objectToRemove(2514, 3857);
objectToRemove(2516, 3857);
objectToRemove(2516, 3852);
objectToRemove(2515, 3852);
objectToRemove(2514, 3852);
	...
	public boolean inPitsWait() {
                return c.getX() == 30874 && c.getY() == 34984;
        }
...
c.sendMessage("<col=255><shad=255>Welcome to Conquest 317! We're glad that you decided to join.</col></shad>");
c.sendMessage("<col=255><shad=255>Josh is the owner.</col></shad>");
c.sendMessage("You have recieved <col=255>1/2</col> starters for this ip adress.");
...
c.sendMessage("<col=255><shad=255>Welcome to Conquest 317! We're glad that you decided to join.</col></shad>");
c.sendMessage("<col=255><shad=255>Josh is the owner.</col></shad>");
c.sendMessage("You have recieved <col=255>2/2</col> starters for this ip adress.");
...
c.sendMessage("<col=255><shad=255>Welcome to Conquest 317! We're glad that you decided to join.</col></shad>");
c.sendMessage("<col=255><shad=255>Josh is the owner.</col></shad>");
c.sendMessage("You have  already recieved <col=255>2/2</col>starters! YOU CANT HAVE FREE ITEMS!");
...
public void useOperate(int itemId) {
	...
	public void handleLoginText() {
		c.getPA().sendFrame126("Mini-Game Teleports", 13037);
		c.getPA().sendFrame126("Slayer Dungeon", 13047);
		c.getPA().sendFrame126("Island Teleport", 13055);
		c.getPA().sendFrame126("Player Killing", 13063);
		c.getPA().sendFrame126("Skilling Island", 13071);
		c.getPA().sendFrame126("Mini-Game Teleports", 1300);
		c.getPA().sendFrame126("Slayer Dungeon", 1325);
		c.getPA().sendFrame126("Island Teleport", 1350);
		c.getPA().sendFrame126("Player Killing", 1382);
		c.getPA().sendFrame126("Skilling Island", 1415);
		c.getPA().sendFrame126("Gold Member's Skilling", 1454);	
		c.getPA().sendFrame126("Tormented Demons", 7457);
		c.getPA().sendFrame126("God Wars Dungeon", 13097);
		c.getPA().sendFrame126("Tormented Demons", 13089);
		c.getPA().sendFrame126("Gold Member's Skilling", 13081);
   	}
