...
public class ControlPanel extends JFrame {
	...
	public void initComponents() {
		...
		MESSAGE_ALL_BOX.setEditable(true);
		MESSAGE_ALL_BOX.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "[Alert]", "[Update]", "[Server]", "[Justin]", "[Control Panel]", "[Panel]", "[Console]", "[Prompt]", "[None]" }));
		MESSAGE_ALL_BOX.setToolTipText("Choose a name that will show next to the message.");
