...
public class MysqlManager {
	...
	public static String MySQLDataBase = "none";
	public static String MySQLURL = "none";
	public static String MySQLUser = "none";
	public static String MySQLPassword = "none";
	...
	public synchronized static void createConnection() {
		try {
			...
			//conn = DriverManager.getConnection("jdbc:mysql://", "REPLACE", "REPLACE");
