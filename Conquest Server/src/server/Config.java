...
public class Config {
	...
	/*public static final String SERVER_NAME = "Conquest 317";*/
	public static String SERVER_NAME = "Conquest 317";
	public static final String WELCOME_MESSAGE = "Welcome to Conquest 317";
	public static final String FORUMS = "http://www.Conquest-317.com/";
	public static final String OWNER = "Josh";
	public static final String CO_OWNER = "Geoff";
	public static final String HEAD_ADMIN = "open";
	public static final String HEAD_MOD = "open";
	public static final int CLIENT_VERSION = 1;
	
	public static int MESSAGE_DELAY = 6000;
	public static final int ITEM_LIMIT = 23000; // item id limit, different clients have more items like silab which goes past 15000
	public static final int MAXITEM_AMOUNT = Integer.MAX_VALUE;
	public static final int BANK_SIZE = 500;
	public static final int MAX_PLAYERS = 9999;
	public static int MAX_NPCS = Server.npcHandler.maxNPCs;

	//public static String DEATH_MESSAGE = "Oh no, you died!";

	public static final int CONNECTION_DELAY = 100; // how long one ip can keep connecting
	public static final int IPS_ALLOWED = 10; // how many ips are allowed
	...
	public static final boolean ADMIN_CAN_STAKE = false; // can admin stake items?
	...
	public static final int START_LOCATION_X = 2767; // start here
	public static final int START_LOCATION_Y = 2979;
	public static final int RESPAWN_X = 2767; // when dead respawn here
	public static final int RESPAWN_Y = 2979;
	public static final int DUNG_RESPAWN_X = 3021; // when dead respawn here
	public static final int DUNG_RESPAWN_Y = 5190;
	...
	public static final int MELEE_EXP_RATE = 275; // damage * exp rate
	public static final int RANGE_EXP_RATE = 275;
	public static final int MAGIC_EXP_RATE = 275;
	...
	*/	
	public static final int WOODCUTTING_EXPERIENCE = 85;///Works
	public static final int MINING_EXPERIENCE = 85;///Works
	public static final int SMITHING_EXPERIENCE = 85;///Works
	public static final int FARMING_EXPERIENCE = 85;///Works
	public static final int FIREMAKING_EXPERIENCE = 80;///Works
	public static final int HERBLORE_EXPERIENCE = 85;///Works
	public static final int FISHING_EXPERIENCE = 85;///Broke
	public static final int AGILITY_EXPERIENCE = 85;///Broke
	public static final int PRAYER_EXPERIENCE = 85;///Works
	public static final int RUNECRAFTING_EXPERIENCE = 85;///Works
	public static final int CRAFTING_EXPERIENCE = 85;///Works
	public static final int THIEVING_EXPERIENCE = 85;///Works
	public static final int SLAYER_EXPERIENCE = 85;///Works
	public static final int COOKING_EXPERIENCE = 85;///Works
	public static final int FLETCHING_EXPERIENCE = 85;///Works
	public static final int CONSTRUCTION_EXPERIENCE = 35;///Works
}
