	...
	public static void unpack(NamedArchive archive, RSFont rsFonts[], NamedArchive streamLoader_1) {
		...
		while(stream.currentOffset < stream.buffer.length) {
			...
			if(rsInterface.interfaceType == 4) {
				rsInterface.disabledMessage = stream.readString().replaceAll("RuneScape", "Conquest 317");
		...
		buyRXPShop1(rsFonts);
			...
			donatorInterface(rsFonts);//Donator Interface by Chubby
			skilllevel(rsFonts);
...
choosespell(rsFonts);
	...
	addText(15245, "@gre@Rock Crabs", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(15236, "@gre@Taverly Dungeon", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(15237, "@gre@Slayer Tower", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(15238, "@gre@Brimhaven Dungeon", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	addText(16235, "@gre@Island", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	addHoverButton(19232, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Bee Hive Mini", -1, 19233, 1);
	addHoveredButton(19233, "Interfaces/minigame/SHADE", 2, 124, 26, 19234);
	addText(19245, "@gre@Barrows", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(19236, "@gre@Pest Control", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(19237, "@gre@Tzhaar", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(19238, "@gre@Bee Hive Mini", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	public static void BossTab1(RSFont[] tda) {
	...
	addHoverButton(22232, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Corporeal Beast", -1, 22233, 1);
	addHoveredButton(22233, "Interfaces/minigame/SHADE", 2, 124, 26, 22234);
	addText(22245, "@gre@Godwars", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(22236, "@gre@King Black Dragon", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(22237, "@gre@Dagannoth Kings", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(22238, "@gre@Corporeal Beast", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	public static void BossTab2(RSFont[] tda) {
	RSInterface tab = addTabInterface(33320);
	addSprite(33321, 1, "Interfaces/minigame/BACKGROUND");
	addText(33322, "Boss Teleports", tda, 2, 0xd67b29, true, true);
	addHoverButton(33323, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Tormented Demons", -1, 33324, 1);
	addHoveredButton(33324, "Interfaces/minigame/SHADE", 2, 124, 26, 33325);
	addHoverButton(33326, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Icy Bones", -1, 33327, 1);
	addHoveredButton(33327, "Interfaces/minigame/SHADE", 2, 124, 26, 33328);
	addHoverButton(33329, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Balance Elemental", -1, 33330, 1);
	addHoveredButton(33330, "Interfaces/minigame/SHADE", 2, 124, 26, 33331);
	addHoverButton(33332, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Sea Troll Queen", -1, 33333, 1);
	addHoveredButton(33333, "Interfaces/minigame/SHADE", 2, 124, 26, 33334);
	addText(33335, "@gre@Tormented Demons", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(33336, "@gre@Icy Bones", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(33337, "@gre@Balance Elemental", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(33338, "@gre@Sea Troll Queen", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addHoverButton(33339, "Interfaces/minigame/shadedMageBook", 1, 43, 35, "Back To Your Spell Book", -1, 33340, 1);
	addHoveredButton(33340, "Interfaces/minigame/hoveredMageBook", 2, 43, 35, 33341);
	addHoverButton(33342, "Interfaces/minigame/shadedArrow", 1, 43, 35, "Next Page", -1, 33343, 1);
	addHoveredButton(33343, "Interfaces/minigame/HoveredArrow", 2, 43, 35, 33344);
	addHoverButton(33345, "Interfaces/minigame/backshadedArrow", 1, 43, 35, "Previous Page", -1, 33346, 1);
	addHoveredButton(33346, "Interfaces/minigame/backHoveredArrow", 2, 43, 35, 33347);
	
	tab.totalChildren(20);
	tab.child(0, 33321, 0, 0);
	tab.child(1, 33322, 95, 7);
	tab.child(2, 33323, 25, 36);
	tab.child(3, 33324, 25, 36);
	tab.child(4, 33326, 25, 86);
	tab.child(5, 33327, 25, 86);
	tab.child(6, 33329, 25, 139);
	tab.child(7, 33330, 25, 139);
	tab.child(8, 33332, 25, 188);
	tab.child(9, 33333, 25, 188);
	tab.child(10, 33335, 87, 43);
	tab.child(11, 33336, 87, 93);
	tab.child(12, 33337, 87, 146);
	tab.child(13, 33338, 87, 195);
	tab.child(14, 33339, 0, 221);
	tab.child(15, 33340, 0, 221);
	tab.child(16, 33342, 147, 221);
	tab.child(17, 33343, 147, 221);
	tab.child(18, 33345, 106, 221);
	tab.child(19, 33346, 106, 221);
	}
	public static void BossTab3(RSFont[] tda) {
	RSInterface tab = addTabInterface(44420);
	addSprite(44421, 1, "Interfaces/minigame/BACKGROUND");
	addText(44422, "Boss Teleports", tda, 2, 0xd67b29, true, true);
	addHoverButton(44423, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Nomad", -1, 44424, 1);
	addHoveredButton(44424, "Interfaces/minigame/SHADE", 2, 124, 26, 44425);
	addHoverButton(44426, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Bal'lak the Pummeller", -1, 44427, 1);
	addHoveredButton(44427, "Interfaces/minigame/SHADE", 2, 124, 26, 44428);
	addHoverButton(44429, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Giant Mole", -1, 44430, 1);
	addHoveredButton(44430, "Interfaces/minigame/SHADE", 2, 124, 26, 44431);
	addHoverButton(44432, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Kalphite Queen", -1, 44433, 1);
	addHoveredButton(44433, "Interfaces/minigame/SHADE", 2, 124, 26, 44434);
	addText(44435, "@gre@Nomad", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(44436, "@gre@Bal'lak", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(44437, "@gre@Giant Mole", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(44438, "@gre@Kalphite Queen", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addHoverButton(44439, "Interfaces/minigame/shadedMageBook", 1, 43, 35, "Back To Your Spell Book", -1, 44440, 1);
	addHoveredButton(44440, "Interfaces/minigame/hoveredMageBook", 2, 43, 35, 44441);
	addHoverButton(44442, "Interfaces/minigame/shadedArrow", 1, 43, 35, "Next Page", -1, 44443, 1);
	addHoveredButton(44443, "Interfaces/minigame/HoveredArrow", 2, 43, 35, 44444);
	addHoverButton(44445, "Interfaces/minigame/backshadedArrow", 1, 43, 35, "Previous Page", -1, 44446, 1);
	addHoveredButton(44446, "Interfaces/minigame/backHoveredArrow", 2, 43, 35, 44447);
	
	tab.totalChildren(20);
	tab.child(0, 44421, 0, 0);
	tab.child(1, 44422, 95, 7);
	tab.child(2, 44423, 25, 36);
	tab.child(3, 44424, 25, 36);
	tab.child(4, 44426, 25, 86);
	tab.child(5, 44427, 25, 86);
	tab.child(6, 44429, 25, 139);
	tab.child(7, 44430, 25, 139);
	tab.child(8, 44432, 25, 188);
	tab.child(9, 44433, 25, 188);
	tab.child(10, 44435, 87, 43);
	tab.child(11, 44436, 87, 93);
	tab.child(12, 44437, 87, 146);
	tab.child(13, 44438, 87, 195);
	tab.child(14, 44439, 0, 221);
	tab.child(15, 44440, 0, 221);
	tab.child(16, 44442, 147, 221);
	tab.child(17, 44443, 147, 221);
	tab.child(18, 44445, 106, 221);
	tab.child(19, 44446, 106, 221);
	}
	public static void BossTab4(RSFont[] tda) {
	RSInterface tab = addTabInterface(33420);
	addSprite(33421, 1, "Interfaces/minigame/BACKGROUND");
	addText(33422, "Boss Teleports", tda, 2, 0xd67b29, true, true);
	addHoverButton(33423, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Pheonix Lair", -1, 33424, 1);
	addHoveredButton(33424, "Interfaces/minigame/SHADE", 2, 124, 26, 33425);
	addHoverButton(33426, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Rammernauts", -1, 33427, 1);
	addHoveredButton(33427, "Interfaces/minigame/SHADE", 2, 124, 26, 33428);
	addHoverButton(33429, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Arzinian Avatars(Wild)", -1, 33430, 1);
	addHoveredButton(33430, "Interfaces/minigame/SHADE", 2, 124, 26, 33431);
	addHoverButton(33432, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Nex", -1, 33433, 1);
	addHoveredButton(33433, "Interfaces/minigame/SHADE", 2, 124, 26, 33434);
	addText(33435, "@gre@Pheonix Lair", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(33436, "@gre@Rammernauts", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(33437, "@gre@Avatars(Wild)", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(33438, "@gre@Nex", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addHoverButton(33439, "Interfaces/minigame/shadedMageBook", 1, 43, 35, "Back To Your Spell Book", -1, 33440, 1);
	addHoveredButton(33440, "Interfaces/minigame/hoveredMageBook", 2, 43, 35, 33441);
	//addHoverButton(33442, "Interfaces/minigame/shadedArrow", 1, 43, 35, "Next Page", -1, 33443, 1);
	//addHoveredButton(33443, "Interfaces/minigame/HoveredArrow", 2, 43, 35, 33444);
	addHoverButton(33442, "Interfaces/minigame/backshadedArrow", 1, 43, 35, "Previous Page", -1, 33443, 1);
	addHoveredButton(33443, "Interfaces/minigame/backHoveredArrow", 2, 43, 35, 33444);
	
	tab.totalChildren(18);
	tab.child(0, 33421, 0, 0);
	tab.child(1, 33422, 95, 7);
	tab.child(2, 33423, 25, 36);
	tab.child(3, 33424, 25, 36);
	tab.child(4, 33426, 25, 86);
	tab.child(5, 33427, 25, 86);
	tab.child(6, 33429, 25, 139);
	tab.child(7, 33430, 25, 139);
	tab.child(8, 33432, 25, 188);
	tab.child(9, 33433, 25, 188);
	tab.child(10, 33435, 87, 43);
	tab.child(11, 33436, 87, 93);
	tab.child(12, 33437, 87, 146);
	tab.child(13, 33438, 87, 195);
	tab.child(14, 33439, 0, 221);
	tab.child(15, 33440, 0, 221);
	tab.child(16, 33442, 147, 221);
	tab.child(17, 33443, 147, 221);
	//tab.child(18, 44645, 106, 221);
	//tab.child(19, 44646, 106, 221);
	}
	...
	addText(24245, "@or2@Edge Ville", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(24236, "@red@Graveyard", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(24237, "@gre@FunPK", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(24238, "@red@Greater Demons", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	addText(25235, "@red@Ardy Lever", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	addText(27245, "@gre@Mining", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(27236, "@gre@Smithing", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(27237, "@gre@Fishing/cooking", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(27238, "@gre@Woodcutting", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	RSInterface tab = addTabInterface(28220);
		addSprite(28221, 1, "Interfaces/minigame/BACKGROUND");
	addText(28222, "Skilling Teleports", tda, 2, 0xd67b29, true, true);
	addHoverButton(28223, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Farming", -1, 28224, 1);
	addHoveredButton(28224, "Interfaces/minigame/SHADE", 2, 124, 26, 28225);
	addHoverButton(28226, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Agility", -1, 28227, 1);
	addHoveredButton(28227, "Interfaces/minigame/SHADE", 2, 124, 26, 28228);
	addHoverButton(28229, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Hunter", -1, 28230, 1);
	addHoveredButton(28230, "Interfaces/minigame/SHADE", 2, 124, 26, 28231);
	addHoverButton(28232, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Theiving", -1, 28233, 1);
	addHoveredButton(28233, "Interfaces/minigame/SHADE", 2, 124, 26, 28234);
	addText(28245, "@gre@Farming", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(28236, "@gre@Agility", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(28237, "@gre@Hunter", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(28238, "@gre@Theiving", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addHoverButton(28239, "Interfaces/minigame/shadedMageBook", 1, 43, 35, "Back To Your Spell Book", -1, 28240, 1);
	addHoveredButton(28240, "Interfaces/minigame/hoveredMageBook", 2, 43, 35, 28241);
	addHoverButton(28272, "Interfaces/minigame/backshadedArrow", 1, 43, 35, "Previous Page", -1, 28243, 1);
	addHoveredButton(28243, "Interfaces/minigame/backHoveredArrow", 2, 43, 35, 28244);
	...
	tab.child(4, 28226, 25, 86);
	tab.child(5, 28227, 25, 86);
	tab.child(6, 28229, 25, 139);
	tab.child(7, 28230, 25, 139);
	tab.child(8, 28232, 25, 188);
	tab.child(9, 28233, 25, 188);
	tab.child(10, 28245, 87, 43);
	tab.child(11, 28236, 87, 93);
	tab.child(12, 28237, 87, 146);
	tab.child(13, 28238, 87, 195);
	tab.child(14, 28239, 0, 221);
	tab.child(15, 28240, 0, 221);
	tab.child(16, 28272, 147, 221);
	tab.child(17, 28243, 147, 221);
	}
	...
	addText(28235, "@gre@Farming", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	addText(28248, "@gre@Agility", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addHoverButton(28249, "Interfaces/monsterTeleb/HOVER", 1, 124, 26, "Teleport to @gre@Hunter", -1, 28250, 1);
	addHoveredButton(28251, "Interfaces/monsterTeleb/SHADE", 2, 124, 26, 28252);
	addText(28253, "@gre@Hunter", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addHoverButton(28254, "Interfaces/monsterTeleb/HOVER", 1, 124, 26, "Teleport to @gre@Theiving", -1, 28255, 1);
	addHoveredButton(28256, "Interfaces/monsterTeleb/SHADE", 2, 124, 26, 28257);
	addText(28258, "@gre@Theiving", tda, 0, 0xFFFFFF, true, true);
	...
	tab.child(12, 28249, 25, 139);
	tab.child(13, 28251, 25, 139);
	tab.child(14, 28253, 87, 146);
	tab.child(15, 28254, 25, 195);
	tab.child(16, 28256, 87, 195);
	tab.child(17, 28258, 87, 195);
	}*/
	public static void Citytele(RSFont[] tda) {
	RSInterface tab = addTabInterface(31520);
	addSprite(31521, 1, "Interfaces/minigame/BACKGROUND");
	addText(31522, "City Teleports", tda, 2, 0xd67b29, true, true);
	addHoverButton(31523, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Lumbridge", -1, 31524, 1);
	addHoveredButton(31524, "Interfaces/minigame/SHADE", 2, 124, 26, 31525);
	addHoverButton(31526, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Varrock", -1, 31527, 1);
	addHoveredButton(31527, "Interfaces/minigame/SHADE", 2, 124, 26, 31528);
	addHoverButton(31529, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Falador", -1, 31530, 1);
	addHoveredButton(31530, "Interfaces/minigame/SHADE", 2, 124, 26, 31531);
	addHoverButton(31532, "Interfaces/minigame/HOVER", 1, 124, 26, "Teleport to @gre@Canifis", -1, 31533, 1);
	addHoveredButton(31533, "Interfaces/minigame/SHADE", 2, 124, 26, 31534);
	addText(31545, "@gre@Lumbridge", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31545, "@gre@Lumbridge", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31545, "@gre@Lumbridge", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31545, "@gre@Lumbridge", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31545, "@gre@Lumbridge", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	...
	addText(31545, "@gre@Lumbridge", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31545, "@gre@Lumbridge", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31536, "@gre@Varrock", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31537, "@gre@Falador", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addText(31538, "@gre@Canifis", tda, 0, 0xFFFFFF, true, true); //0xd67b29
	addHoverButton(31539, "Interfaces/minigame/shadedMageBook", 1, 43, 35, "Back To Your Spell Book", -1, 31540, 1);
	addHoveredButton(31541, "Interfaces/minigame/hoveredMageBook", 2, 43, 35, 31542);
//	addHoverButton(31572, "Interfaces/minigame/shadedArrow", 1, 43, 35, "Next Page", -1, 31543, 1);
//	addHoveredButton(31543, "Interfaces/minigame/HoveredArrow", 2, 43, 35, 31544);
	
	tab.totalChildren(16);
	tab.child(0, 31521, 0, 0);
	tab.child(1, 31522, 95, 7);
	tab.child(2, 31523, 25, 36);
	tab.child(3, 31524, 25, 36);
	tab.child(4, 31526, 25, 86);
	tab.child(5, 31527, 25, 86);
	tab.child(6, 31529, 25, 139);
	tab.child(7, 31530, 25, 139);
	tab.child(8, 31532, 25, 188);
	tab.child(9, 31533, 25, 188);
	tab.child(10, 31545, 87, 43);
	tab.child(11, 31536, 87, 93);
	tab.child(12, 31537, 87, 146);
	tab.child(13, 31538, 87, 195);
	tab.child(14, 31539, 0, 221);
	tab.child(15, 31541, 0, 221);
//	tab.child(16, 31572, 147, 221);
//	tab.child(17, 31543, 147, 221);
	}
	/*Teleport Tabs End*/
...
/* 4409 */     addHoverButton1(21923, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21924, 1);
/* 4410 */     addHoveredButton(21924, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21925);
/* 4411 */     addSprite(21922, 44, "Interfaces/TitleShop/SPRITE");
/* 4412 */     addHoverButton1(21926, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21927, 1);
/* 4413 */     addHoveredButton(21927, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21928);
/* 4414 */     addHoverButton1(21929, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21930, 1);
/* 4415 */     addHoveredButton(21930, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21931);
/* 4416 */     addHoverButton1(21932, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21933, 1);
/* 4417 */     addHoveredButton(21933, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21934);
/* 4418 */     addHoverButton1(21935, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21936, 1);
/* 4419 */     addHoveredButton(21936, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21937);
/* 4420 */     addHoverButton1(21938, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21939, 1);
/* 4421 */     addHoveredButton(21939, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21940);
/*      */ 
/* 4423 */     addHoverButton1(21941, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21942, 1);
/* 4424 */     addHoveredButton(21942, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21943);
/* 4425 */     addHoverButton1(21944, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21945, 1);
/* 4426 */     addHoveredButton(21945, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21946);
/* 4427 */     addHoverButton1(21947, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21948, 1);
/* 4428 */     addHoveredButton(21948, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21949);
/*      */ 
/* 4430 */     addHoverButton1(21950, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21951, 1);
/* 4431 */     addHoveredButton(21951, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21952);
/* 4432 */     addHoverButton1(21953, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21954, 1);
/* 4433 */     addHoveredButton(21954, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21955);
/* 4434 */     addHoverButton1(21956, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21957, 1);
/* 4435 */     addHoveredButton(21957, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21958);
/*      */ 
/* 4437 */     addHoverButton1(21959, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21960, 1);
/* 4438 */     addHoveredButton(21960, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21961);
/* 4439 */     addHoverButton1(21962, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21963, 1);
/* 4440 */     addHoveredButton(21963, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21964);
/* 4441 */     addHoverButton1(21965, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21966, 1);
/* 4442 */     addHoveredButton(21966, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21967);
/*      */ 
/* 4444 */     addHoverButton1(21968, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21969, 1);
/* 4445 */     addHoveredButton(21969, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21970);
/* 4446 */     addHoverButton1(21971, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21972, 1);
/* 4447 */     addHoveredButton(21972, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21973);
				addHoverButton1(21761, "Interfaces/TitleShop/SPRITE", 8, 56, 11, "Get", 21762, 1);
				addHoveredButton(21762, "Interfaces/TitleShop/SPRITE", 7, 56, 11, 21763);
/*      */ 
/* 4449 */     addText(21919, "Sir", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4450 */     addText(21920, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4451 */     addText(21921, "Get", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4452 */     addText(21974, "Lord", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4453 */     addText(21975, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4454 */     addText(21976, "Lionheart", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4455 */     addText(21977, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4456 */     addText(21978, "Donator", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4457 */     addText(21979, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4458 */     addText(21980, "Bandito", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4459 */     addText(21981, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4460 */     addText(21982, "King", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4461 */     addText(21843, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4462 */     addText(21842, "Big Cheese", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4463 */     addText(21985, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4464 */     addText(21986, "Wunderkind", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4465 */     addText(21987, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4466 */     addText(21988, "Crusader", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4467 */     addText(21989, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4468 */     addText(21990, "Overlord", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4469 */     addText(21991, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4470 */     addText(21992, "Count", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4471 */     addText(21993, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4472 */     addText(21994, "Legend", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4473 */     addText(21995, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4474 */     addText(21996, "Hell Raiser", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4475 */     addText(21848, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4476 */     addText(21847, "Baron", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4477 */     addText(21846, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4478 */     addText(21845, "Duke", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4479 */     addText(21844, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4480 */     addText(21841, "Lady", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4481 */     addText(21840, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4482 */     addText(21839, "The Great", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4483 */     addText(21838, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4484 */    addText(21837, "Dudette", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4485 */    addText(21836, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/* 4486 */	   addText(21835, "Baroness", paramArrayOfRSFont, 0, 15122040, false, true);
/* 4487 */    addText(21834, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
			addText(21833, "Countess", paramArrayOfRSFont, 0, 15122040, false, true);
				addText(21832, "Free", paramArrayOfRSFont, 0, 14389248, false, true);
/*      */ 
...
/*      */ 
/* 4538 */     localRSInterface2.totalChildren(110);
...
/* 4655 */     localRSInterface2.child(101, 21838, 160, 274);
			   localRSInterface2.child(102, 21837, 301, 263);
			   localRSInterface2.child(103, 21836, 278, 274);
			   localRSInterface2.child(104, 21835, 52, 313);
			   localRSInterface2.child(105, 21834, 42, 324);
			   localRSInterface2.child(106, 21833, 180, 313);
			   localRSInterface2.child(107, 21832, 160, 324);
			   localRSInterface2.child(108, 21761, 180, 313); //button
			   localRSInterface2.child(109, 21762, 160, 324); //button
/* 4656 */     localRSInterface2.width = 357;
/* 4657 */     localRSInterface2.height = 238;
/* 4658 */     localRSInterface2.scrollMax = 500;
/*      */   }
/*      */ 
...
public static void itemsOnDeath(RSFont[] wid) {
		...
		addSprite(17101, 2, "Interfaces/Death/SPRITE");
		addHover(17102, 3, 0, 10601, 1, "Interfaces/Death/SPRITE", 17, 17, "Close Window");
		addHovered(10601, 3, "Interfaces/Death/SPRITE", 17, 17, 10602);
		addText(17103, "1", wid, 2, 0xff981f);
	...
	public static void itemsOnDeathDATA(RSFont[] wid) {
		...
		addText(17109, "7", wid, 0, 0xff981f);		addText(17110, "b", wid, 0, 0xff981f);		addText(17111, "c", wid, 0, 0xff981f);
		addText(17112, "8", wid, 0, 0xff981f);		addText(17113, "e", wid, 0, 0xff981f);		addText(17114, "f", wid, 0, 0xff981f);
		addText(17117, "9", wid, 0, 0xff981f);		addText(17118, "h", wid, 0, 0xff981f);		addText(17119, "i", wid, 0, 0xff981f);
		addText(17120, "10", wid, 0, 0xff981f);		addText(17121, "k", wid, 0, 0xff981f);		addText(17122, "l", wid, 0, 0xff981f);
		addText(17123, "11", wid, 0, 0xff981f);		addText(17124, "n", wid, 0, 0xff981f);		addText(17125, "o", wid, 0, 0xff981f);
		addText(17126, "12", wid, 0, 0xff981f);		addText(17127, "q", wid, 0, 0xff981f);		addText(17128, "r", wid, 0, 0xff981f);
		addText(17129, "13", wid, 0, 0xff981f);		addText(17130, "t", wid, 0, 0xff981f);
    ...
    { 
        RSInterface Interface = addInterface(19282);
		setChildren(4, Interface);
		addSprite(19283, 0, "Interfaces/Players Online/Background");
		addHoverButton(19284, "Interfaces/Players Online/EXIT", 0, 58, 17, "Exit", -1, 19285, 1);
		addHoveredButton(19285, "Interfaces/Players Online/EXIT1", 1, 58, 17, 19286);
		setBounds(19286, 6, 0, 0, Interface); // loading background
		setBounds(19287, 300, 60, 1, Interface); // loading scroll bar
		setBounds(19288, 482, 7, 2, Interface); // loading EXIT BUTTON
		setBounds(19289, 482, 7, 3, Interface); // loading EXIT BUTTON HOVER
...
public static void donatorInterface(RSFont[] TDA) {
    ...
    addText(25905, "Conquest 317 - Donator", TDA, 2, 0xFF9900, false, true);//Title
	addSprite(25906, 0, "Interfaces/donatorInterface/BANNER");// Background
	addHoverButton(25907, "Interfaces/donatorInterface/BUTTON", 0, 180, 25, "Yes I want!", -1, 25908, 1);//Done Button
	addHoveredButton(25908, "Interfaces/donatorInterface/BUTTON", 1, 180, 25, 25909);//Done Button Hover
    addText(25910, "Yes, please.", TDA, 1, 0xFFFFFF, false, true);//Done Button Text
	addHoverButton(25911, "Interfaces/donatorInterface/BUTTON", 0, 180, 25, "No thank you.", -1, 25912, 1);//Done Button
	addHoveredButton(25912, "Interfaces/donatorInterface/BUTTON", 1, 180, 25, 25913);//Done Button Hover
    addText(25914, "No thank you.", TDA, 1, 0xFFFFFF, false, true);//Done Button Text
    addText(25915, "Hello, it seems to me you are thinking about becoming an Conquest 317 Donator!", TDA, 0, 0xFFFFFF, false, true);//Text1
    addText(25916, "Well right now...I am giving you the chance to make your choice.", TDA, 0, 0xFFFFFF, false, true);//Text2
    addText(25917, "Donators recieve many benefits, and titles. Make your final choice below!", TDA, 0, 0xFFFFFF, false, true);//Text3
	...
	setBounds(25914, 320, 264, 9, Interface);//Button 2 Text
	...
	public void specialBar(int id) {//7599
		...
		rsi.width = 152;
		rsi.height = 28;
		rsi.child(0, id-12, 1, 3);
		rsi.child(12, id+1, 1, 3);
		rsi.child(23, id+12, 16, 9);
        for (int i = 13; i < 23; i++) {
            rsi.childY[i] -= 1;
        }
...
/*NewLevelUp*/
	...
	public static void questTab(RSFont[] TDA){
		...
		addHoverText(29162, "Justin", "Owners", TDA, 0, 0xff0000, false, true, 150);
		addText(29163, "Register on :", 0xFF981F, false, true, 52, TDA, 2);
		addHoverText(29164, "http://www.Conquest 317x.tk/", "Register", TDA, 0, 0xff0000, false, true, 150);
...
public static void Rules(RSFont[] tda)
  {
    ...
    addHoveredButton(17256, "Interfaces/Rules/SPRITE", 7, 78, 39, 17257);
                addText(17800, "@gre@Play", tda, 0, 0x33ff00, false, true);
                addText(17801, "@red@Exit", tda, 0, 0xff0000, false, true);
                addText(17802, "@bla@Conquest 317 Decision:", tda, 2, 0xff981f, false, true);
                addText(17803, "@gre@Would you like to stay and play, or exit Conquest 317?", tda, 0, 0xff981f, false, true);
                ...
                for(int i = 14001; i <= 14030; i++){
                addText(i, "", tda, 1, 0xffffff, false, true);
                addText(14008, "@gre@Current Staff:", tda, 2, 0xff981f, true, true);
                addText(14009, "@blu@[Founder]Justin", tda, 0, 0xff981f, true, true);
                addText(14011, "@gre@Conquest 317 Rules:", tda, 2, 0xff981f, true, true);
                addText(14012, "@red@Pretending to act like a member of the staff is not allowed.", tda, 0, 0xff981f, true, true);
                addText(14014, "@red@Scamming", tda, 2, 0xff981f, true, true);
                addText(14015, "@red@Scamming player's items is not allowed.", tda, 0, 0xff981f, true, true);
                addText(14017, "@yel@Bug Abuse:", tda, 2, 0xff981f, true, true);
                addText(14018, "@red@Abusing a glitch is not allowed, you must report it immediately", tda, 0, 0xff981f, true, true);
                addText(14020, "@red@Advertising/Spamming:", tda, 2, 0xff981f, true, true);
                addText(14021, "@red@Advertising servers and spamming will not be tolerated.", tda, 0, 0xff981f, true, true);
                addText(14023, "@red@Encouraging Rule Breaking:", tda, 2, 0xff981f, true, true);
                addText(14024, "@red@Encouraging others to break rules is strictly forbidden", tda, 0, 0xff981f, true, true);
                addText(14026, "@yel@Pking:", tda, 2, 0xff981f, true, true);
                addText(14027, "@red@No Pkpoints farming, (Gbs fights are your own risk)", tda, 0, 0xff981f, true, true);
                }
                tab.totalChildren(30);
                int Child = 0;
                int Y = 5;
...
public static void friendsTab(RSFont[] kam) {
        ...
        addText(5068, "Conquest 317", kam, 1, 0xff9933, true, true);
	...
	*/
	...
	public static void configureCharDesign(RSFont[] TDA) {
		...
		addText(3649, "Welcome to Conquest 317 - Use the buttons below to design your player", TDA, 2, 0xFF9442);
