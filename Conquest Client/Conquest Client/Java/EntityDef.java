...
entitydef.name = "Nex";
entitydef.aByte68 = 3;
//entitydef.renderEmote = 358;
entitydef.anInt77 = 6320;
entitydef.anInt67 = 6319;
...
if(i == 9)
        {
		 ...
		 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Attack";
    
            entitydef.anIntArray94 = new int[9];
            entitydef.anIntArray94[0] = 6686;//helm
            entitydef.anIntArray94[1] = 6698;//plate
            entitydef.anIntArray94[2] = -1;//kite
            entitydef.anIntArray94[3] = 6702;//wep
            entitydef.anIntArray94[4] = 6692;//legs
            entitydef.anIntArray94[5] = 9640;//cape
            entitydef.anIntArray94[6] = 4680;//boots
            entitydef.anIntArray94[7] = 13319;//gloves
            entitydef.anIntArray94[8] = 9644;//ammulet
		
            entitydef.name = "Zoft";
          
	entitydef.combatLevel = 126;
            entitydef.description = "I heard he once ruled these lands.".getBytes();
        }
if(i == 7400) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Exchange";
    entitydef.name = "Certificate Exchanger";
	
	entitydef.combatLevel = 138;
}
if(i == 912) {

    entitydef.name = "Zamorak Minion";
	
	entitydef.combatLevel = 247;
}
if(i == 913) {

    entitydef.name = "Saradomin Minion";
	
	entitydef.combatLevel = 247;
}
if(i == 914) {

    entitydef.name = "Guthix Minion";
	
	entitydef.combatLevel = 247;
}
if(i == 6788) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Swap Prayers/Magics";
    entitydef.name = "Priest of Conquest 317";
	
	entitydef.combatLevel = 138;
}
if(i == 3328) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Browse Wares";
    entitydef.name = "Slayer Farm Owner";
	
	entitydef.combatLevel = 6996;
}
if(i == 6365) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Trade With";
    entitydef.name = "Zamorak Mentor";
...
if(i == 6258) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Trade With";
    entitydef.name = "Saradomin Mentor";
...
if(i == 8008) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Trade With";
    entitydef.name = "Guthix Mentor";
	
	entitydef.combatLevel = 9999;
}
if(i == 3098) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "View List";
    entitydef.name = "Teleporter";
...
if(i == 521) {
 entitydef.itemActions = new String[5];
    ...
    entitydef.name = "Armour & Weapons Salesman";
...
if(i == 5896) {
 entitydef.itemActions = new String[5];
    entitydef.itemActions[0] = "Trade";
    entitydef.name = "Boss Endurance Rewards";
