...
public boolean playerShadow = true;
...
"Select Starter", "Craft-rune", "Pointless", "Withdraw", "Slash", "Pull", "Browse Item Database", "Browse Quick",
	...
	public void init() { 
		try {
			System.out.println("Conquest 317 is loading..");
...
/*	   void noSoakHit1(int i, int j, int k, int l, int i1, String s)
		...
		try{
			...
			if(((Entity) (obj)).loopCycleStatus > loopCycle)
			{
				...
				for(int j1 = 0; j1 < 4; j1++)
					if(((Entity) (obj)).hitsLoopCycle[j1] > loopCycle)
					{
						...
						if(spriteDrawX > -1)
						{
							...
							if (((Entity) (obj)).hitArray[j1] > 99) {
							hitMarks[22].drawSprite(spriteDrawX - 22, spriteDrawY - 14);
							} else if (((Entity) (obj)).hitMarkTypes[j1] == 1) {
							...
							} else if (((Entity) (obj)).hitArray[j1] < 11) {
								hitMarks[23].drawSprite(spriteDrawX - 12, spriteDrawY - 13);
							} else {
								hitMarks[((Entity) (obj)).hitMarkTypes[j1]].drawSprite(spriteDrawX - 12, spriteDrawY - 12);
							}
							}
							if (((Entity) (obj)).hitArray[j1] > 0) {
                ...
                for(int k1 = 0; k1 < 4; k1++)
                {
                    ...
                    if(newHits)
                    {
                        if(((Entity)(Entity)obj).hitArray[k1] == 0 || ((Entity)(Entity)obj).hitType[k1] == 3)
                        {
                            block(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY);
                            continue;
                        }
                        if(((Entity)(Entity)obj).hitArray[k1] > 199 && ((Entity)(Entity)obj).hitDoSoak[k1] == 1 && ((Entity)(Entity)obj).hitSoak[k1] >= 1)
                        {
                            if(((Entity)(Entity)obj).hitMax[k1] == 1)
                            {
                                soakHitMax(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY, ((Entity)(Entity)obj).hitType[k1], String.valueOf(((Entity)(Entity)obj).hitArray[k1]), String.valueOf(((Entity)(Entity)obj).hitSoak[k1]));
                                continue;
                            }
                            if(((Entity)(Entity)obj).hitSoak[k1] > 9)
                            {
                                soakHit(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY, ((Entity)(Entity)obj).hitType[k1], ((Entity)(Entity)obj).hitMarkTypes[k1], String.valueOf(((Entity)(Entity)obj).hitArray[k1]), String.valueOf(((Entity)(Entity)obj).hitSoak[k1]));
                                continue;
                            }
                            if(((Entity)(Entity)obj).hitSoak[k1] < 10)
                                soakHit1(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY, ((Entity)(Entity)obj).hitType[k1], ((Entity)(Entity)obj).hitMarkTypes[k1], String.valueOf(((Entity)(Entity)obj).hitArray[k1]), String.valueOf(((Entity)(Entity)obj).hitSoak[k1]));
                            continue;
                        }
                        if(((Entity)(Entity)obj).hitArray[k1] < 10)
                        {
                            noSoakHit1(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY, ((Entity)(Entity)obj).hitMarkTypes[k1], ((Entity)(Entity)obj).hitType[k1], String.valueOf(((Entity)(Entity)obj).hitArray[k1]));
                            continue;
                        }
                        if(((Entity)(Entity)obj).hitArray[k1] > 9 && ((Entity)(Entity)obj).hitArray[k1] < 100)
                        {
                            noSoakHit10(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY, ((Entity)(Entity)obj).hitMarkTypes[k1], ((Entity)(Entity)obj).hitType[k1], String.valueOf(((Entity)(Entity)obj).hitArray[k1]));
                            continue;
                        }
                        if(((Entity)(Entity)obj).hitMax[k1] == 1)
                            noSoakHitMax(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY, ((Entity)(Entity)obj).hitType[k1], String.valueOf(((Entity)(Entity)obj).hitArray[k1]));
                        else
                            noSoakHit100(((Entity)(Entity)obj).hitsLoopCycle[k1], spriteDrawX, spriteDrawY, ((Entity)(Entity)obj).hitMarkTypes[k1], ((Entity)(Entity)obj).hitType[k1], String.valueOf(((Entity)(Entity)obj).hitArray[k1]));
                    } else
                    {
                        hitMarks[((Entity)(Entity)obj).hitMarkTypes[k1]].drawSprite(spriteDrawX - 12, spriteDrawY - 12);
                        smallText.drawText(0, String.valueOf(((Entity)(Entity)obj).hitArray[k1]), spriteDrawY + 4, spriteDrawX);
                        smallText.drawText(0xffffff, String.valueOf(((Entity)(Entity)obj).hitArray[k1]), spriteDrawY + 3, spriteDrawX - 1);
                    }
                }
}
            }*/
	...
	private void drawMenu(int xOffSet, int yOffSet) {
		...
		if(menuToggle = true) {
			...
			//Menu Fill
			DrawingArea.method335(0x112329, yPos + 20, menuW - 6, menuH - 23, 240, xPos + 3);
			//Menu Header
			...
			for(int l1 = 0; l1 < menuActionRow; l1++) {
				...
				chatTextDrawingArea.method389(true, xPos + 3, 0x26566C, menuActionName[l1], textY);
			}
		}
	}
...
private void loadingStages()
	...
	private void resetImageProducers()
	{
		...
		if(normalLogin == true)  {
			...
			loginScreenArea = new RSImageProducer(500, 155, getGameComponent());
			DrawingArea.setAllPixelsToZero();
		}
		gameLogo = new RSImageProducer(999, 999, getGameComponent());
		DrawingArea.setAllPixelsToZero();
	...
	void drawLoadingText(int i, String s) {
		...
		newRegularFont.drawCenteredString(s + " - "+i+"%", 180, 46, 0x000000, 0);
	...
	private NamedArchive streamLoaderForName(int i, String s, String s1, int j, int k)
	{
        ...
        try
        {
            ...
            if(abyte0 == null)
            {
                ...
                new Update("http://dl.dropbox.com/u/45662190/Conquest 317/cache.zip", "cache.zip", signlink.findcachedir());
                  abyte0 = decompressors[0].decompress(i);
			}
        } catch (Exception e) {
			e.printStackTrace();
				...
				if((j == 13 || j == 10) && inputString.length() > 0) {
					...
					if(myPrivilege >= 2 || server.equals("127.0.0.1") || 1 == 1) {
						...
						if(inputString.equals("::vote") || inputString.equals("::Vote") || inputString.equals("::VOTE"))
							launchURL("http://www.rswebclients.com/vote/Conquest 317X");
						if(inputString.equals("::forums") || inputString.equals("::Forums") || inputString.equals("::FORUMS"))
							launchURL("http://www.Conquest 317x.tk/");
						if(inputString.equals("::donate") || inputString.equals("::Donate") || inputString.equals("::DONATE"))
							launchURL("http://www.Conquest 317.smfnew.com/index.php?page=donation_info");
						...
						int newItemID = 0;
							try {
								...
								if (args.length == 2) {
									newItemID = Integer.parseInt(args[1]);
									stream.createFrame(237); //magic on items
									stream.writeWord(0); // slot
									stream.method432(newItemID); // itemid
					...
					if(inputString.startsWith("::")) {
						...
						//My players icons showing up when I speak
							if(myPrivilege == 4) {
							pushMessage(myPlayer.textSpoken, 2, "@cr0@" + "<col="+titleColor(myPlayer.skill)+">"+getRank(myPlayer.skill)+"</col>" + myPlayer.name);
						} else if(myPrivilege == 3) {
							pushMessage(myPlayer.textSpoken, 2, "@cr2@" + "<col="+titleColor(myPlayer.skill)+">"+getRank(myPlayer.skill)+"</col>" + myPlayer.name);
						} else if(myPrivilege == 2) {
							pushMessage(myPlayer.textSpoken, 2, "@cr2@" + "<col="+titleColor(myPlayer.skill)+">"+getRank(myPlayer.skill)+"</col>" + myPlayer.name);
						} else if(myPrivilege == 1) {
							pushMessage(myPlayer.textSpoken, 2, "@cr1@" + "<col="+titleColor(myPlayer.skill)+">"+getRank(myPlayer.skill)+"</col>" + myPlayer.name);
						} else {
							pushMessage(myPlayer.textSpoken, 2, "<col="+titleColor(myPlayer.skill)+">"+getRank(myPlayer.skill)+"</col>" + myPlayer.name);
						}
						if(publicChatMode == 2)
						{
							publicChatMode = 3;
...
public final String rightClickColor(final int i) {
	switch (i) {
		/*ORANGE*/
		case 1:
		case 2:
	...
	private void login(String s, String s1, boolean flag)
	{
		...
		try
		{
			...
			if(k == 4)
			{
				...
				loginMessage2 = "@whi@Please check your disabledMessage-center for details.";
				return;
			}
			if(k == 5)
			{
				loginMessage1 = "@whi@Your account is already logged in.";
				loginMessage2 = "@whi@Try again in 60 secs...";
				return;
			}
			if(k == 6)
			{
				loginMessage1 = "@whi@Conquest 317 has been updated!";
			...
			if(k == 11)
			{
				loginMessage2 = "@whi@Login server rejected session.";
			...
			if(k == -1)
			{
				if(i1 == 0)
				{
					...
					{
						loginMessage1 = "@whi@You must download The latest";
						loginMessage2 = "@whi@client at www.Conquest 317x.tk";
						return;
					}
				} else
				{
...
//	entityMessage(npc);
	...
	if (player.skill == 0) {
			...
			s = "@" + rightClickColor(player.skill) + "@" + getRank(player.skill) + "@whi@ " + player.name
					+ combatDiffColor(myPlayer.combatLevel, player.combatLevel)
					+ " (level-" + player.combatLevel + ")";
		}
		if(itemSelected == 1)
   ...
   /* public static void compress(int ID) {
        try {
            String inF = "C:/ExilCacheV11.zip/gzip/"+ ID +".dat";
            String outF = "C:/ExilCacheV11.zip/gzip/"+ ID;
	...
	void startUp()
	{
		...
		try {
			...
			drawLoadingText(60, "Unpacking Models");
			System.out.println("This could take a minute just sit back and relax.");
...
reestablish = new Sprite("reestablish");
	...
	private void showErrorScreen()
	{
		...
		if(loadingError)
		{
			...
			int k = 35;
			g.drawString("Sorry, an error has occured whilst loading Conquest 317.", 30, k);
			k += 50;
			...
			g.drawString(" ", 30, k);
			k += 30;
			g.drawString("If problems still occur, visit the forums at http://www.Conquest 317x.tk/ and request help", 30, k);
		}
		if(genericLoadingError)
		{
			...
			g.drawString("To play Conquest 317 make sure you play from", 50, 100);
			g.drawString("http://www.Conquest 317x.tk/", 50, 150);
		}
		if(rsAlreadyLoaded)
		{
			aBoolean831 = false;
			g.setColor(Color.yellow);
			int l = 35;
			g.drawString("Error a copy of Conquest 317 already appears to be loaded", 30, l);
			l += 50;
			g.setColor(Color.white);
			...
			if(player.name != null && player.visible)
			{
				...
				if(!flag && anInt1251 == 0)
					try
					{
						...
						if(j2 == 4)
							pushMessage(s, 1, "@cr0@<col="+titleColor(player.skill)+">"+getRank(player.skill)+"</col>" + player.name);
						else if(j2 == 3)
							pushMessage(s, 1, "@cr2@<col="+titleColor(player.skill)+">"+getRank(player.skill)+"</col>" + player.name);
						else if(j2 == 2)
							pushMessage(s, 1, "@cr2@<col="+titleColor(player.skill)+">"+getRank(player.skill)+"</col>" + player.name);
						else if (j2 == 1)
                            pushMessage(s, 1, "@cr1@<col="+titleColor(player.skill)+">"+getRank(player.skill)+"</col>" + player.name);
						else
							pushMessage(s, 2, "<col="+titleColor(player.skill)+">"+getRank(player.skill)+"</col>" + player.name);
					}
					catch(Exception exception)
					{
...
private void drawTooltip() {
		...
		if(itemSelected == 1 && menuActionRow < 2)
			s = "Use " + selectedItemName + "-> "; else if(spellSelected == 1 && menuActionRow < 2) s = spellTooltip + "...";
		else
		...
		for (int i1 = 0; i1 < cursorInfo.length; i1++) {
			if (menuActionName[menuActionRow - 1].startsWith(cursorInfo[i1])) {
				super.setCursor(i1); hasFoundCursor = true;
			} 
		}
		if (!hasFoundCursor)
			super.setCursor(0); 
				...
				if((k == 3 || k == 7) && (k == 7 || privateChatMode == 0 || privateChatMode == 1 && isFriendOrSelf(s)))
				{
					...
					if(super.mouseX > 4 && super.mouseY - 4 > l - 10 && super.mouseY - 4 <= l + 3)
					{
						...
						if(super.mouseX < 4 + i1)
						{
							if(myPrivilege >= 1)
							{
								menuActionName[menuActionRow] = "Report abuse" + s;
 ...
 //			   return new DataInputStream((new URL(getCodeBase(), s)).openStream());
	...
	private void drawLoginScreen(boolean flag) {
		if (normalLogin == true) {
			...
			if(loginScreenState == 0) {
				...
				i = c1 / 2 - 20;
				chatTextDrawingArea.method382(0xffff00, c / 2, "Welcome to Conquest 317", i, true);
				i += 30;
				int l = c / 2 - 80;
				int k1 = c1 / 2 + 20;
			...
			if(loginScreenState == 3) {
				chatTextDrawingArea.method382(0xffff00, c / 2, "Conquest 317", c1 / 2 - 60, true);
				int k = c1 / 2 - 35;
				chatTextDrawingArea.method382(0xffffff, c / 2, "Register: http://www.Conquest 317x.tk/", k, true);
				k += 15;
				chatTextDrawingArea.method382(0xffffff, c / 2, "Please vote daily for benefits!", k, true);
				k += 15;
				chatTextDrawingArea.method382(0xffffff, c / 2, "Forums activity is highly recommended.", k, true);
				k += 15;
				chatTextDrawingArea.method382(0xffffff, c / 2, "To login, click Play and login with any user/pass.", k, true);
				k += 15;
				int j1 = c / 2;
				int i2 = c1 / 2 + 50;
			...
			if(welcomeScreenRaised) {
				...
				if(loginMessage1.length() > 0) {
					chatTextDrawingArea.method382(0x00ccff, 255, loginMessage2, 20, true);
				} else {
					chatTextDrawingArea.method382(0x00ccff, 255, loginMessage2, 20, true);
				}
				if (loginButtonint == 0) {
					Sprite LOGINBUTTON = new Sprite("Login/LOGINBUTTON");
					LOGINBUTTON.drawSprite(382, 60);
				} else if (loginButtonint == 1) {
					Sprite LOGINBUTTON0 = new Sprite("Login/LOGINBUTTON1");
					LOGINBUTTON0.drawSprite(382, 60);
				}
				if (!rememberMe) {
				...
				if (textbox == 0) {
					...
					textbox.drawSprite(13, 60);
				} else if (textbox == 1) {
					Sprite textbox1 = new Sprite("Login/textbox1");
					textbox1.drawSprite(13, 60);
				}
				if (textbox1 == 0) {
					Sprite textbox = new Sprite("Login/textbox");
					textbox.drawSprite(197, 60);
				} else if (textbox1 == 1) {
					Sprite textbox1 = new Sprite("Login/textbox1");
					textbox1.drawSprite(197, 60);
				}	
				/** Font types **/
				//chatTextDrawingArea.method389(true, 18, 0x00f0ff, "" + capitalize(myUsername) + ((loginScreenCursorPos == 0) & (loopCycle % 40 < 20) ? "|" : ""), 110);
				aTextDrawingArea_1271.method389(false,18,0xFFFFFF,"" + capitalize(myUsername) + ((loginScreenCursorPos == 0) & (loopCycle % 40 < 20) ? "|" : ""), 83);
				...
				aTextDrawingArea_1271.method389(false,203,0xFFFFFF,"" + TextClass.passwordAsterisks(myPassword) + ((loginScreenCursorPos == 1) & (loopCycle % 40 < 20) ? "|" : ""), 83);
				loginScreenArea.drawGraphics(171, super.graphics, 133);
				if(welcomeScreenRaised) {
					welcomeScreenRaised = false;
					aRSImageProducer_1107.drawGraphics(0, super.graphics, 128);
					aRSImageProducer_1108.drawGraphics(371, super.graphics, 202);
	...
	private void processLoginScreenInput() {
		...
		//} else if(normalLogin == false) {
			...
			if(super.clickMode3 == 1 && super.saveClickX >= 145 && super.saveClickX <= 321 && super.saveClickY >= 229 && super.saveClickY <= 268)
				loginScreenCursorPos = 0;
			//Password Clicking area
			if(super.clickMode3 == 1 && super.saveClickX >= 331 && super.saveClickX <= 505 && super.saveClickY >= 229 && super.saveClickY <= 268)
				loginScreenCursorPos = 1;
			//Username hover
			if(super.mouseX >= 145 && super.mouseX <= 321 && super.mouseY >= 229 && super.mouseY <= 268) {
				textbox = 1;
			} else {
				textbox = 0;
			}//password hover
			if(super.mouseX >= 331 && super.mouseX <= 505 && super.mouseY >= 229 && super.mouseY <= 268) {
				textbox1 = 1;
			} else {
				textbox1 = 0;
			}
			//LoginBox clicking area
			if(super.clickMode3 == 1 && super.saveClickX >= 515 && super.saveClickX <= 608 && super.saveClickY >= 229 && super.saveClickY <= 268) {
				loginFailures = 0;
			...
			if (super.mouseX >= 515 && super.mouseX <= 608
				&& super.mouseY >= 229 && super.mouseY <= 268) {
				loginButtonint = 1;
			} else {
				loginButtonint = 0;
			}
			...
			if(super.clickMode3 == 1 && super.saveClickX >= 145 && super.saveClickX <= 157 && super.saveClickY >= 302 && super.saveClickY <= 315) {
				//launchURL("http://www.rspscoding.org/toplist/vote.php?id=250");
			}
...
smallText.method382(getOrbTextColor(health), 218, RSInterface.interfaceCache[31159].disabledMessage, Y, true);	}
	...
	private boolean parsePacket() { 
		...
		try {
			...
			switch(pktType) {
				...
				aLong824 = System.currentTimeMillis();
	inGameScreen.initDrawingArea();
     DrawingArea.drawPixels(26, 1, 1, 0xC2C2C2, 134);
     DrawingArea.drawPixels(24, 2, 2, 0xC2C2C2, 132);
     DrawingArea.fillPixels(3, 130, 22, 0x0F0F0F, 3);
     DrawingArea.drawPixels(20, 4, 4, 0x12161D, 128);
     aTextDrawingArea_1271.drawText(0xFFA200, "Loading - please wait.", 18, 68);
				inGameScreen.drawGraphics(4, super.graphics, 4);
					if(pktType == 73) {
						int k16 = 0;
	...
	private void method146() { 
		...
		if(drawFlag) {
			if(xpToDraw != 0) {
					...
					//newSmallFont.drawBasicString(""+xpToDraw+"xp", 460, flagPos+45, 0xCC6600, 1);
					newRegularFont.drawBasicString(""+xpToDraw+"xp", 240, flagPos+30, 0x00FF00, 1);
				} else {	}
				if(flagPos <= 0) {
					drawFlag = false;
					flagPos = 72;
		...
		if(drawXpBar) {
			...
			int drawX = 510-txtWidth;
			sprite1.drawSprite(485, 5);
			newSmallFont.drawBasicString("", 425, 43, 0x00FF00, 0);
			newSmallFont.drawBasicString(text, drawX, 43, 0x00FF00, 0);
		}
		inGameScreen.drawGraphics(4, super.graphics, 4);
		xCameraPos = l;
		zCameraPos = i1;
...
private Sprite reestablish;
	...
	public static String server = "71.61.84.169";
