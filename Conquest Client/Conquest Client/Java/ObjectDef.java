...
if (i == 11005) {
                ...
                objectDef.itemActions[0] = null;
                objectDef.itemActions[1] = "Pass Through";
                objectDef.name = "Gold Member's Barrier";
                objectDef.description = "Allows entry to only Gold Members!".getBytes();
            }
if (i == 2470) {
                objectDef.itemActions = new String[5];
                objectDef.itemActions[0] = null;
                objectDef.itemActions[1] = "Use";
                objectDef.name = "Slayer Farm Portal";
                objectDef.description = "Provides access to the Slayer Farm.".getBytes();
            }
if (i == 2995) {
               
             
                objectDef.name = "Bank Chest";
                objectDef.description = "Allows access to your bank account.".getBytes();
            }
if (i == 2732) {
                objectDef.itemActions = new String[5];
                objectDef.itemActions[0] = null;
                objectDef.itemActions[1] = "Add-Logs";
                objectDef.name = "Fire";
